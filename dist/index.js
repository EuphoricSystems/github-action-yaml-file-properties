...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const file_path = core_1.default.getInput('file_path');
        const prop_path = core_1.default.getInput('prop_path');
        let pathArr = [];
        if (prop_path) {
            pathArr = prop_path.split('.');
        }
        try {
            const buffer = yield fs_1.promises.readFile(file_path);
            ...
            if (json && typeof json === 'object') {
                for (const key in json) {
                    core_1.default.setOutput(key, json[key]);
                }
            }
            else if (json) {
                core_1.default.setOutput('value', json);
            }
            else {
                core_1.default.setFailed(`can not find prop_path: ${prop_path} in json file.`);
            }
        }
        catch (error) {
